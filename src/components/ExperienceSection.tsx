  ...
  const experiences = [
    {
      ...
      achievements: [
        "Developed full-stack catering and event management platform using Django and Flutter",
        ...
        "Integrated Functionalities and automated email notifications",
      ],
    },
    {
      company: "QSpiders",
      ...
      achievements: [
        ...
        "Gained hands-on experience with Git, Django and API implementation",
